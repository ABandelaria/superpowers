...
6. **Write design doc** — save to `docs/specs/YYYY-MM-DD-<topic>-design.md` (local only, do not commit)
...
- Do NOT commit the design document — it stays local only
...
> "Spec written to `<path>` (kept local, not committed). Please review it and let me know if you want to make any changes before we start writing out the implementation plan."
