...
mkdir -p src test docs/battle-plans

# Create a simple implementation plan
cat > docs/battle-plans/implementation-plan.md <<'EOF'
...
I want you to execute the implementation plan at docs/battle-plans/implementation-plan.md using the subagent-driven-development skill.
...
PROMPT="Execute the implementation plan at docs/battle-plans/implementation-plan.md using the subagent-driven-development skill.
